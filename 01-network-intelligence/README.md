...
The Network Intelligence capability is implemented through six interconnected intelligence patterns that progressively transform fragmented data into connected investigative intelligence.

| Capability | Description |
|------------|-------------|
| [NI001 – Entity Resolution](01-entity-resolution/README.md) | Consolidate fragmented customer, account and reference records into trusted investigative entities |
| [NI002 – Relationship Discovery](02-relationship-discovery/README.md) | Identify direct and indirect relationships between individuals, organisations, accounts and assets |
| [NI003 – Beneficial Ownership Intelligence](03-beneficial-ownership/README.md) | Reveal ownership structures, controlling parties and Ultimate Beneficial Owners (UBOs) |
| [NI004 – Network Risk Assessment](04-network-risk-assessment/README.md) | Assess risk exposure across connected entities and identify network-level risk indicators |
| [NI005 – Investigation Workflow Intelligence](05-investigation-workflows/README.md) | Operationalise intelligence through structured investigative workflows and decision processes |
| [NI006 – AI Investigator Copilot](../05-ai-investigator-copilot/README.md) | Accelerate investigations using AI-assisted intelligence analysis, summarisation and recommendations |

---

## Recommended Reading Journey

The Network Intelligence capability stack is designed to be explored in the following sequence:

**NI001 → NI002 → NI003 → NI004 → NI005 → NI006**

Each capability consumes intelligence generated by earlier stages and produces intelligence that enables subsequent investigative activities.

---

## Financial Crime Analytics Showcase Portfolio
...
➡️ Begin with **[NI001 – Entity Resolution](01-entity-resolution/README.md)** to start the Network Intelligence investigation journey.
